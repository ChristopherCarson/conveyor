...
var Toggle = function Toggle(_ref3) {
  ...
  switch (stateNode.toggle) {
    case toggleState.EXPAND:
      component = _react["default"].createElement(_fa.FaAngleDown, {
        className: "tree-toggle-icon-angle-down"
      });
      break;

    case toggleState.MINIMIZE:
      component = _react["default"].createElement(_fa.FaAngleRight, {
        className: "tree-toggle-icon-angle-right"
      });
      break;
