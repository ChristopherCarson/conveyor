  ...
  return _react["default"].createElement("div", {
    ...
    onClick: function onClick() {
      return onChangePage({
        ...
        updatedPageIndex: _goto,
        isValid: 1 <= _goto && _goto <= lastIndex && Number.isInteger(_goto)
      });
    }
  }, "Go"))));
};
...
var PaginationLink = function PaginationLink(_ref2) {
  ...
  if (isNaN(text)) {
    return _react["default"].createElement(_reactTippy.Tooltip, {
      html: _react["default"].createElement("span", null, "Page ".concat(updatedPageIndex))
    }, link);
  }
...
var Pagination = function Pagination(_ref3) {
  ...
  var hasFirst = idx > 2;
  var hasPrev = idx > 1;
  var hasNext = lastIndex > 1 && idx < lastIndex;
  var hasLast = lastIndex > 1 && idx < lastIndex - 1; // no pagination
  ...
  }, (idx - 1) * amtPerPage + 1, "-", Math.min(idx * amtPerPage, totalDataLength), " of", ' ', totalDataLength)));
};
...
var IndexPagination = function IndexPagination(_ref4) {
  ...
  var idx = R.propOr(1, 'currentPage', page); // get index of last hypothetical data point

  var lastIndex = R.prop('lastIndex', page);
  var totalDataLength = R.prop('total', page);
  var amtPerPage = R.prop('amtPerPage', page);
