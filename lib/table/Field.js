...
var getRelSchemaEntry = function getRelSchemaEntry(_ref) {
  ...
  var fieldTargetModel = R.path(['type', 'target'], schema.getField(modelName, fieldName));
...
var FieldCurrency = function FieldCurrency(_ref5) {
  ...
  var displayString = new Intl.NumberFormat('en-US', {
    style: 'currency',
    currency: 'USD'
  }).format(num);
...
var FieldEnum = function FieldEnum(_ref6) {
  ...
  if (value) {
    return _react["default"].createElement("span", null, schema.getEnumLabel(modelName, fieldName, value));
  }
...
var FieldImageModal = function FieldImageModal(_ref7) {
  ...
  var label = schema.getFieldLabel({
    modelName: modelName,
    fieldName: fieldName,
    node: node,
    customProps: customProps
  });
  var modalId = "img-modal-".concat(modelName, "-").concat(fieldName, "-").concat(id);
...
var FieldToOne = function FieldToOne(_ref8) {
  ...
  var displayTooltip = schema.getTooltipFields({
    modelName: relModelName,
    customProps: customProps
  }).length !== 0;
